...
export const metadata: Metadata = {
  title: "Photo Gallery",
  description: "Explore photos from services, outreaches, and special events at Teliosis World Outreach.",
  openGraph: {
    title: "Photo Gallery – Teliosis World Outreach",
    description: "Explore photos from services, outreaches, and special events at Teliosis World Outreach.",
    url: "/media/gallery",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Teliosis World Outreach Photo Gallery",
      },
    ],
  },
  twitter: {
      ...
      <section className="bg-zinc-900 py-20 text-center text-white">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <p className="mx-auto max-w-2xl text-lg leading-relaxed text-gray-400">
            Explore photos from services, outreaches, and special events at Teliosis World Outreach.
          </p>
        </div>
      </section>
